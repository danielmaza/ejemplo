...
public class ModeloClienteDAO extends ModeloDAO{
       ...
       { 
              ...
              { 
                     ...
                     consultaString = "SELECT * FROM cliente WHERE idCliente=?"; //el ? es la forma como se espera un parámetro
       ...
       { 
              ...
              { 
                     ...
                     consultaString = "CALL paAnadirCliente(?,?);";
       ...
       { 
              ...
              { 
                     ...
                     // Eliminar el cliente 
                     consultaString="DELETE FROM cliente WHERE idCliente=?";
       ...
       { 
              ...
              { 
                     ...
                     // Ejecución de la consulta 
                     codigoError=consulta.executeUpdate(); 
                     System.out.println("Codigo de executeUdate: " + codigoError);
              } 
              catch(Exception e) 
              { 
